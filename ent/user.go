...
func (e UserEdges) CpsOrErr() ([]*CP, error) {
	if e.loadedTypes[0] {
		return e.Cps, nil
	}
...
// QueryCps queries the "cps" edge of the User entity.
func (_m *User) QueryCps() *CPQuery {
	return NewUserClient(_m.config).QueryCps(_m)
}
